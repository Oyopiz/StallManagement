...
public class MystallsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_mystalls, container, false);
        ...
        FirebaseRecyclerOptions<Stalls> options = new FirebaseRecyclerOptions.Builder<Stalls>().setQuery(query, Stalls.class).build();
